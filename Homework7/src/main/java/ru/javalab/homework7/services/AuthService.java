...
public class AuthService implements Component {
    RoleRepositoryImpl roleRepository = ApplicationContextReflectionBased.getInstance().getComponent(RoleRepositoryImpl.class);
    ...
    public String getToken(User user) {
        try {
            ...
            payload.isAdmin = roleRepository.getPermissionByUserId(payload.id);
